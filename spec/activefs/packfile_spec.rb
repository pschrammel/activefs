...
describe Activefs::Packfile do
  ...
  it "should get an entry" do
    ...
    #th="3eae1599bb7f187b86d6427942d172ba8dd7ee5962aab03e0839ad9d59c37eb0"
    ...
    flat= FastLZ.decompress(content)
    p flat
    p flat.size
    recompressed=FastLZ.compress(content)
    #recompressed.should ==content
  end
end
